...
MODELOS = {
    'ollama': 'llama3.1:8b',                    # modelo local
}
...
- Ley 9107 (Socorro a víctimas de catástrofe del Perú) → 1. Asistencia directa a víctimas de desastre.
- Ley 23248 (Pensiones a derechohabientes de víctimas de accidente aéreo) → 1. Reparación económica a familiares de víctimas.
- Ley 4554 (Subsidio a víctimas de crecientes de ríos) → 1. Otorga subsidio directo a víctimas de catástrofe.
...
def main():
    ...
    # Guardar
    output = f'resultado_{CLASIFICADOR_ACTIVO}2.xlsx'
